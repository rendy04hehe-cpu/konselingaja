...
# Load environment variables from .env file (hanya di root proyek).
...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'django-insecure-t)pssz1i3eftb$e&matcb-jx*@14rr8p-af%@1x3q0#euj&%v_',
)
...
# Default: SQLite (dev). Produksi (Railway): set DATABASE_URL.
DATABASES = {
...
# WhiteNoise untuk static files production (Railway)
STORAGES = {
    'default': {
